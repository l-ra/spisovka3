...
class Environment
{
    ...
    {
        return new Caching\Cache(self::getContext()->getByType('Nette\Caching\IStorage'),
                $namespace);
    }
    ...
    {
        return $namespace === NULL ? self::getContext()->getByType('Nette\Http\Session') : self::getContext()->getByType('Nette\Http\Session')->getSection($namespace);
    }
