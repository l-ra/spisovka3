...
class Admin_CiselnikyPresenter extends BasePresenter
{
    ...
    public function actionSpousteciudalost()
    {
        ...
        $ciselnik->addColumn('poznamka_k_datumu',
                    array(
